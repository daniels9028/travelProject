  ...
  return (
    <div className="container mx-auto flex py-24 px-6">
      <div className="flex flex-col text-white lg:w-1/2 w-full gap-4">
        <h1 className="lg:text-[40px] text-[30px] mt-8 font-waterBrush tracking-wider capitalize">
          {title}
        </h1>

        <h2 className="lg:text-[50px] text-[40px] font-bold font-workSans capitalize">
          {subtitle}
        </h2>

        <p className="font-workSans lg:text-xl text-base mb-10 text-wrap capitalize">
          {description}
        </p>
